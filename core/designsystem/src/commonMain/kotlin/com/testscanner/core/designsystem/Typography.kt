 ...
 */
val CodeValueStyle: TextStyle = scanlyStyle(
    size = 16,
    lineHeight = 24,
...
internal val ScanlyTypography = Typography(
    ...
    displayLarge = scanlyStyle(size = 57, lineHeight = 64, weight = FontWeight.SemiBold, letterSpacing = -0.5),
    displayMedium = scanlyStyle(size = 45, lineHeight = 52, weight = FontWeight.SemiBold, letterSpacing = -0.4),
    displaySmall = scanlyStyle(size = 36, lineHeight = 44, weight = FontWeight.SemiBold, letterSpacing = -0.3),

    headlineLarge = scanlyStyle(size = 32, lineHeight = 40, weight = FontWeight.SemiBold, letterSpacing = -0.2),
    headlineMedium = scanlyStyle(size = 28, lineHeight = 36, weight = FontWeight.SemiBold, letterSpacing = -0.2),
    headlineSmall = scanlyStyle(size = 24, lineHeight = 32, weight = FontWeight.SemiBold, letterSpacing = -0.1),
    ...
    titleLarge = scanlyStyle(size = 22, lineHeight = 28, weight = FontWeight.SemiBold, letterSpacing = 0.0),
    titleMedium = scanlyStyle(size = 17, lineHeight = 24, weight = FontWeight.SemiBold, letterSpacing = 0.1),
    titleSmall = scanlyStyle(size = 15, lineHeight = 20, weight = FontWeight.SemiBold, letterSpacing = 0.1),
    ...
    bodyLarge = scanlyStyle(size = 16, lineHeight = 24, weight = FontWeight.Normal, letterSpacing = 0.0),
    bodyMedium = scanlyStyle(size = 14, lineHeight = 20, weight = FontWeight.Normal, letterSpacing = 0.1),
    bodySmall = scanlyStyle(size = 13, lineHeight = 18, weight = FontWeight.Normal, letterSpacing = 0.1),
    ...
    labelLarge = scanlyStyle(size = 14, lineHeight = 20, weight = FontWeight.SemiBold, letterSpacing = 0.1),
    labelMedium = scanlyStyle(size = 12, lineHeight = 16, weight = FontWeight.Medium, letterSpacing = 0.4),
    labelSmall = scanlyStyle(size = 11, lineHeight = 16, weight = FontWeight.Medium, letterSpacing = 0.4),
)
